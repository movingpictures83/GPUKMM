...
void GPUKMMPlugin::input(std::string file) {
...
PluginProxy<GPUKMMPlugin> GPUKMMPluginProxy = PluginProxy<GPUKMMPlugin>("GPUKMM", PluginManager::getInstance());
